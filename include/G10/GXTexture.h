...
// Vulkan Constructors
DLLEXPORT int construct_image_view ( GXTexture_t *p_texture, VkImageViewType view_type, VkFormat format, VkComponentMapping swizzle, VkImageAspectFlags aspect_mask );
