...
// Allocators
DLLEXPORT int     create_bv                ( GXBV_t **bv );                                       // Creates an empty bounding volume

// Constructors
DLLEXPORT int     construct_bv             ( GXBV_t   **bv, vec3       min,     vec3        max);
...
// Tree navigation
DLLEXPORT GXBV_t *find_closest_bv          ( GXBV_t     *bvh   , GXBV_t      *bv );
