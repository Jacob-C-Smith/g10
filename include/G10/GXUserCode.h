 ...
 */
DLLEXPORT int user_code              ( GXInstance_t *p_instance );
 ...
 * @return 1 on success, 0 on error
 */
DLLEXPORT int add_user_code_callback ( GXInstance_t *p_instance, int ( *user_code_callback ) ( GXInstance_t *p_instance ) );