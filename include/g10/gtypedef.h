...
typedef int (fn_bv_bounds_getter)( void *p_object, vec3 *p_min, vec3 *p_max );
...
typedef int (fn_shader_on_draw)( shader *p_shader, void *p_draw_item );
